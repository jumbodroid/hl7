...
namespace Jumbodroid\HL7;

use Jumbodroid\Exceptions\HL7Exception;
...
class Message
{
    ...
    public function __construct(string $msgStr = null, array $hl7Globals = null, bool $keepEmptySubFields = false, bool $resetIndices = false, bool $autoIncrementIndices = true)
    {
        ...
        if ($msgStr) {
            ...
            foreach ($segments as $i => $iValue) {
                ...
                $className = "Jumbodroid\\HL7\\Segments\\$segmentName";
    ...
    public function resetSegmentIndices(): void
    {
        ...
        foreach ($segments as $file) { // ['OBR', 'PID', 'OBX', 'IN1'...]
            $className = "Jumbodroid\\HL7\\Segments\\" . pathinfo($file, PATHINFO_FILENAME);
